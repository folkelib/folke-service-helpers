...
export class SimpleApiClient implements ApiClient {
    constructor(private options?: { onQueryStart?: () => void, onQueryEnd?: () => void, userManager?: UserManager }) {}
    ...
    async fetch(url: string, method: string, data: Data | undefined): Promise<Response> {
        ...
        if (this.options && this.options.userManager) {
            headers.append("Authorization", await this.options.userManager.getAuthorizationHeader());
        }
